# Especificacao Tecnica — Async Patterns

| Field | Value |
|---|---|
| Repository | `python_example_async_patterns` |
...
Asynchronous programming example: coroutines, tasks and concurrency with asyncio. This document describes requirements, architecture, and acceptance criteria.
